...
export class CuacaComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit(): void {
    ...
    this.renderer.addClass(document.body, "sidebar-colsed");
  ...
  bind_table1() : void {
    this.http.get("http://api.openweathermap.org/data/2.5/forecast?id=1630789&appid=0a9d9057d9cf0b5f3f7f31590bf864cc")
    .subscribe((data: any) => {
      console.log(data);
